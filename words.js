...
const words = {
  // Short words only (3-4 letters) for minimal typing mode
  short: [
    "ape", "ant", "arm", "axe", "bag", "bat", "bay", "bed", "bee", "bow",
    "box", "boy", "bug", "bus", "cab", "can", "cap", "car", "cat", "cow",
    "cub", "cup", "dam", "day", "den", "dew", "dog", "dot", "ear", "egg",
    "elk", "elm", "emu", "eye", "fan", "fig", "fin", "fir", "fly", "fog",
    "fox", "fry", "fur", "gem", "god", "gum", "gun", "gut", "gym", "ham",
    "hat", "hay", "hen", "hip", "hog", "hut", "ice", "imp", "ink", "inn",
    "ion", "ivy", "jam", "jar", "jaw", "jay", "jet", "jig", "job", "jog",
    "joy", "jug", "keg", "key", "kid", "kit", "lab", "lap", "law", "leg",
    "lid", "lip", "log", "lot", "map", "mat", "mob", "mop", "mud", "mug",
    "net", "nub", "nun", "nut", "oak", "oar", "oat", "oil", "orb", "ore",
    "owl", "pan", "paw", "pea", "pen", "pet", "pie", "pig", "pin", "pit",
    "pod", "pot", "pup", "rag", "ram", "rat", "ray", "rib", "rim", "rod",
    "rug", "run", "rut", "saw", "sea", "sir", "ski", "sky", "soy", "spa",
    "spy", "sub", "sum", "sun", "tan", "tap", "tar", "tax", "tea", "tin",
    "tip", "toe", "top", "toy", "tub", "tug", "urn", "van", "vat", "vet",
    "vim", "wad", "war", "wax", "web", "wig", "win", "wit", "wok", "yak",
    "yam", "yap", "zap", "zen", "zip", "zoo",
    "acid", "acne", "ally", "alto", "arch", "army", "atom", "aunt", "baby",
    "back", "bail", "bait", "bald", "ball", "band", "bank", "bark", "barn",
    "base", "bath", "bead", "beak", "beam", "bean", "bear", "beat", "beef",
    "beer", "bell", "belt", "bend", "bike", "bird", "bite", "blow", "blue",
    "boar", "boat", "body", "bolt", "bomb", "bond", "bone", "book", "boot",
    "boss", "bowl", "brow", "bulb", "bulk", "bull", "bump", "bunk", "burn",
    "bush", "buzz", "cafe", "cage", "cake", "calf", "calm", "camp", "cane",
    "cape", "card", "carp", "cart", "case", "cash", "cast", "cave", "chef",
    "chin", "chip", "chop", "city", "clam", "clan", "claw", "clay", "clip",
    "club", "clue", "coal", "coat", "cock", "code", "coil", "coin", "coke",
    "cold", "colt", "comb", "cone", "cook", "cool", "cope", "copy", "cord",
    "core", "cork", "corn", "cost", "crab", "crew", "crib", "crop", "crow",
    "cube", "cult", "curb", "cure", "curl", "dale", "dame", "damp", "dare",
    "dark", "dart", "dash", "data", "dawn", "deal", "dear", "debt", "deck",
    "deed", "deer", "demo", "dent", "desk", "dial", "dice", "diet", "dirt",
    "disc", "dish", "disk", "dock", "doll", "dome", "door", "dose", "dove",
    "down", "drag", "draw", "drip", "drop", "drug", "drum", "duck", "dude",
    "duel", "duke", "dump", "dune", "dusk", "dust", "duty", "ease", "east",
    "edge", "epic", "exam", "exit", "face", "fact", "fade", "fail", "fair",
    "fall", "fame", "fang", "farm", "fast", "fate", "fawn", "fear", "feat",
    "feed", "feel", "fern", "file", "film", "find", "fine", "fire", "firm",
    "fish", "fist", "flag", "flap", "flat", "flaw", "flea", "flip", "flow",
    "foam", "foil", "fold", "folk", "font", "food", "fool", "foot", "fork",
    "form", "fort", "fowl", "frog", "fuel", "fund", "fuse", "fuss", "game",
    "gang", "gate", "gaze", "gear", "gift", "gill", "girl", "give", "glad",
    "glow", "glue", "goat", "gold", "golf", "gong", "good", "gown", "grab",
    "gray", "grid", "grim", "grin", "grip", "grit", "grow", "gulf", "gust",
    "hail", "hair", "half", "hall", "halo", "hand", "hang", "hare", "harm",
    "harp", "hate", "hawk", "haze", "head", "heal", "heap", "hear", "heat",
    "heel", "heir", "helm", "help", "hemp", "herb", "herd", "hero", "hide",
    "hill", "hint", "hive", "hold", "hole", "home", "hood", "hoof", "hook",
    "hope", "horn", "hose", "host", "hour", "howl", "huff", "hulk", "hull",
    "hump", "hunt", "hurt", "hymn", "idea", "idol", "inch", "info", "iron",
    "isle", "itch", "item", "jack", "jade", "jail", "jazz", "jean", "jerk",
    "jest", "join", "joke", "jolt", "jump", "june", "junk", "jury", "just",
    "kale", "keel", "kelp", "kick", "kill", "kind", "king", "kiss", "kite",
    "knee", "knob", "knot", "lace", "lack", "lady", "lake", "lamb", "lamp",
    "land", "lane", "lard", "lark", "lash", "last", "late", "lawn", "lead",
    "leaf", "leak", "lean", "leap", "left", "lens", "liar", "lice", "lick",
    "life", "lift", "limb", "lime", "limp", "line", "link", "lint", "lion",
    "list", "live", "load", "loaf", "loan", "lock", "loft", "logo", "long",
    "look", "loom", "loop", "lord", "lore", "loss", "lost", "love", "luck",
    "lump", "lung", "lure", "lurk", "lush", "lynx", "mace", "made", "maid",
    "mail", "main", "make", "male", "mall", "mane", "many", "mare", "mark",
    "mask", "mass", "mast", "mate", "maze", "meal", "mean", "meat", "meet",
    "melt", "memo", "menu", "mesh", "mess", "mice", "mild", "mile", "milk",
    "mill", "mime", "mind", "mine", "mint", "miss", "mist", "mitt", "moat",
    "mock", "mode", "mold", "mole", "monk", "mood", "moon", "moor", "moss",
    "most", "moth", "move", "much", "mule", "mull", "muse", "mush", "must",
    "myth", "nail", "name", "nape", "navy", "near", "neat", "neck", "need",
    "neon", "nerd", "nest", "news", "newt", "next", "nice", "nine", "node",
    "noon", "norm", "nose", "note", "noun", "nova", "nuke", "oath", "oboe",
    "odds", "odor", "ogre", "okay", "omen", "only", "onto", "opal", "open",
    "oral", "orca", "oven", "over", "pace", "pack", "pact", "page", "pail",
    "pain", "pair", "pale", "palm", "pane", "pant", "park", "part", "pass",
    "past", "path", "peak", "pear", "peat", "peck", "peek", "peel", "peer",
    "perk", "pest", "pick", "pier", "pike", "pile", "pill", "pine", "pink",
    "pint", "pipe", "plan", "play", "plea", "plod", "plot", "plow", "plug",
    "plum", "plus", "poem", "poet", "poke", "pole", "poll", "polo", "pond",
    "pony", "pool", "poor", "pope", "pork", "port", "pose", "post", "pour",
    "pray", "prep", "prey", "prop", "pull", "pulp", "pump", "punk", "pure",
    "push", "quiz", "race", "rack", "raft", "rage", "raid", "rail", "rain",
    "rake", "ramp", "rang", "rank", "rant", "rate", "rave", "read", "real",
    "rear", "reed", "reef", "reel", "rent", "rest", "rice", "rich", "ride",
    "rift", "ring", "riot", "rise", "risk", "road", "roam", "roar", "robe",
    "rock", "role", "roll", "roof", "room", "root", "rope", "rose", "ruin",
    "rule", "rung", "rush", "rust", "sack", "safe", "saga", "sage", "said",
    "sail", "sake", "sale", "salt", "same", "sand", "sane", "sang", "sash",
    "save", "scab", "scan", "scar", "seal", "seam", "seat", "sect", "seed",
    "seek", "self", "sell", "shed", "ship", "shop", "shot", "show", "sick",
    "side", "sigh", "sign", "silk", "sing", "sink", "site", "size", "skin",
    "slab", "slam", "slap", "sled", "slew", "slim", "slip", "slit", "slot",
    "slow", "slug", "slum", "snap", "snob", "snow", "snug", "soak", "soap",
    "soar", "sock", "soda", "sofa", "soft", "soil", "sold", "sole", "some",
    "song", "soon", "soot", "sore", "sort", "soul", "soup", "sour", "spam",
    "span", "spar", "spec", "spin", "spit", "spot", "spur", "stab", "star",
    "stay", "stem", "step", "stew", "stir", "stop", "stub", "stud", "stun",
    "such", "suck", "suit", "sulk", "sumo", "sung", "sunk", "surf", "swan",
    "swap", "swim", "tack", "taco", "tail", "take", "tale", "talk", "tall",
    "tame", "tank", "tape", "task", "taxi", "team", "tear", "tech", "tell",
    "temp", "tend", "tent", "term", "test", "text", "that", "thaw", "them",
    "then", "thin", "this", "thus", "tick", "tide", "tidy", "tier", "tile",
    "tilt", "time", "tint", "tiny", "tire", "toad", "toll", "tomb", "tone",
    "tool", "toot", "tops", "tore", "torn", "tort", "toss", "tour", "town",
    "trap", "tray", "tree", "trek", "trim", "trio", "trip", "trot", "true",
    "tuba", "tube", "tuck", "tuft", "tuna", "tune", "turf", "turn", "tusk",
    "twin", "type", "unit", "upon", "urge", "used", "user", "vain", "vase",
    "vast", "veal", "veer", "veil", "vein", "vent", "verb", "very", "vest",
    "veto", "vibe", "vice", "view", "vine", "visa", "void", "volt", "vote",
    "wade", "wage", "wail", "wait", "wake", "walk", "wall", "wand", "want",
    "ward", "warm", "warn", "warp", "wart", "wash", "wasp", "wave", "wavy",
    "weak", "wear", "weed", "week", "well", "went", "west", "what", "when",
    "whip", "whom", "wick", "wide", "wife", "wild", "will", "wilt", "wimp",
    "wind", "wine", "wing", "wink", "wipe", "wire", "wise", "wish", "wolf",
    "womb", "wood", "wool", "word", "wore", "work", "worm", "worn", "wrap",
    "wren", "yard", "yarn", "yawn", "year", "yell", "yelp", "yoga", "yoke",
    "yolk", "your", "zeal", "zero", "zest", "zinc", "zone", "zoom"
  ],
